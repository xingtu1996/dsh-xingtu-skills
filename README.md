***REMOVED*** dsh-xingtu-skills · XingTu Skills Plugin for DeepSeek Harness (DSH)
...
```
dsh-xingtu-skills/
├── package.json        ***REMOVED*** dsh.bundle.patch → ./cordis.patch.yml (standard plugin declaration)
├── cordis.patch.yml    ***REMOVED*** inserts this plugin row (bundle layer)
├── lib/index.js        ***REMOVED*** entry: apply() registers every SKILL.md under skills/
└── skills/<name>/      ***REMOVED*** 26 skill directories (SKILL.md + their resources)
```

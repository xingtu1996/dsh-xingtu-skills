...
> **29 production-grade AI agent skills, packaged as a standard DeepSeek Harness (DSH) plugin — one command to install.**
...
| **Content & media (XingTu self-media)** | `adversarial-review` `codemax-report` `de-ai-flavor` |
...
└── skills/<name>/      # 29 skill directories (SKILL.md + their resources)
```
